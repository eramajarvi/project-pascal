...
@onready var timerLabel: Label = $"../../TimeTracker"
...
func spawn_sphere():
	var VolcanoWithBubblenimation = $VolcanoWithBubble2/VolcanoBubble/Volcano2AnimationPlayer
	VolcanoWithBubblenimation.play("bubbleGoingUp")
	await VolcanoWithBubblenimation.animation_finished
	var soundfuego = $"../../DamageBubbleSpawner-Volcano1/VolcanoWithBubble1/AudioFuegoVolcan"
	...
	var random_x = randf_range(0, 25)
	var random_z = randf_range(-60, -45)
...
func _on_timer_timeout() -> void:
	...
	$"../../Door2/AnimationPlayer".play("moveFinalDoor")
